...
- **How to use**: `python inspector.py agent_core`
- **Lines**: ~400
...
```
agent_core/skills/product/gather_requirements/SKILL.md
```
...
```
agent_core/skills/product/write_spec/SKILL.md
```
...
```
agent_core/skills/architecture/analyze_repo/SKILL.md
```
...
#### 4. Design System
```
agent_core/skills/architecture/design_system/SKILL.md
```
...
#### 5. Plan Tasks
```
agent_core/skills/development/plan_tasks/SKILL.md
```
...
#### 6. Implement Feature
```
agent_core/skills/development/implement_feature/SKILL.md
```
...
#### 7. Refactor Code
```
agent_core/skills/development/refactor_code/SKILL.md
```
...
#### 8. Fix Bug
```
agent_core/skills/development/fix_bug/SKILL.md
```
...
#### 9. Generate Tests
```
agent_core/skills/qa/generate_tests/SKILL.md
```
...
#### 10. Debug Cycle
```
agent_core/skills/qa/debug_cycle/SKILL.md
```
...
#### 11. Review Code
```
agent_core/skills/qa/review_code/SKILL.md
```
...
#### 12. Configure CI
```
agent_core/skills/devops/configure_ci/SKILL.md
```
...
#### 13. Deploy App
```
agent_core/skills/devops/deploy_app/SKILL.md
```
...
#### 14. Update Docs
```
agent_core/skills/docs/update_docs/SKILL.md
```
...
```
agent_core/skills/docs/write_release_notes/SKILL.md
```
...
#### 16. Critic
```
agent_core/skills/control/critic/SKILL.md
```
...
#### 17. Verify Spec
```
agent_core/skills/control/verify_spec/SKILL.md
```
...
### EXAMPLE_REQUEST.md
```
agent_core/tasks/EXAMPLE_REQUEST.md
```
...
- [ ] Read QUICKSTART.md
- [ ] Run `python tools/inspector.py agent_core`
- [ ] Run `python orchestrator.py 001` in agent_core/
