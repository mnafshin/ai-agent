...
- 2026-03-01: PostgreSQL chosen as primary database (see /ai-company/memory/decisions.md#L42)
- 2026-02-15: Authentication via OAuth 2.0 (see /ai-company/memory/decisions.md#L28)
...
cat ai-company/memory/context_template.md > tasks/request_feature_oauth/memory/context.md

# 2. Add relevant global context (manually or via tool)
echo "See /ai-company/memory/decisions.md for full architecture" >> ...
...
See `/ai-company/tools/` for implementation.
